      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-star"></i> Point</li>
            </ol>
          </div>
        </div><!-- /.row -->

        <div class="row">
          <div class="col-lg-3"><!--Poin Pelanggan-->
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    <p class="announcement-heading">Poin Pelanggan</p>
                  </div>
                </div>
              </div>
              <a href="Poinp">
            ...
            <div class="panel panel-warning">
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    <p class="announcement-heading">Penukaran Poin</p>
                  </div>
                </div>
              </div>
              <a href="Penukaranp">
