      ...
      <div class="row">
          <div class="col-lg-12">
            <h1>Edit Data Pelanggan</h1>
              <ol class="breadcrumb">
              <li><i class="fa fa-user"></i> Pelanggan</a></li>
              <li><i class="fa fa-user"></i> Data Pelanggan</li>
              <li class="active"><i class="fa fa-user"></i> Edit Data Pelanggan</li>
            </ol>
            <form action="/updatePelanggan/{{ $data->id }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="string" name="id_pelanggan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  value="{{ $data->id_pelanggan }}">
              </div>
              <div class="form-gro
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="string" name="alamat" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->alamat }}">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1" class="form-label">No Hp</label>
                <input type="string" name="no_hp" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->no_hp }}">
              </div>
              <div class="form-group">
