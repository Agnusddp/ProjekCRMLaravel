      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <form action="/updateTpelanggan/{{ $data->id }}" method="POST" enctype="multipart/form-data">
            @csrf
              <div class="form-group">
                <label for="exampleInputEmail1" class="form-label">Id Transaksi</label>
                <input type="string" name="id_transaksi" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->id_transaksi }}">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1" class="form-label">Tanggal Transaksi</label>
                <input type="string" name="tanggal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->tanggal }}">
              </div>
              <div class="form-group">
                <div class="mb-3">
