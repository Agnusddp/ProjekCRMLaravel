      ...
      <div class="row">
          <div class="col-lg-12">
            <h1>Edit Data Pegawai</h1>
              ...
              <li><i class="fa fa-user"></i> Data Pegawai</li>
              <li class="active"><i class="fa fa-user"></i> Edit Data Pegawai</li>
            </ol>
            <form action="/updatePegawai/{{ $data->id }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="string" name="id_pegawai" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->id_pegawai }}">
              </div>
              <div class="form-group">
