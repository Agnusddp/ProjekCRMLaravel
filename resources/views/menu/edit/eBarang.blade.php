        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-book"></i> Data Barang</li>
              <li class="active"><i class="fa fa-book"></i> Input Data Barang</li>
            </ol>
            ...
            @csrf
              ...
              <div class="form-group">
                ...
                <input type="string" name="stock" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->stock }}">
              </div>
              <p>
