  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Edit Data Penukaran Poin</h1>
            <ol class="breadcrumb">
              <li><i class="fa fa-star"></i> Point</li>
              <li><i class="fa fa-clock-o"></i> Penukaran Poin</li>
              <li class="active"><i class="fa fa-clock-o"></i> Edit Penukaran Poin</li>
            </ol>
            <form action="/updatePenukaranp/{{ $data->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="exampleInputEmail1" class="form-label">Id Penukaran</label>
                <input type="string" name="id_penukaran" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->id_penukaran }}">
              </div>
            <div class="form-group">
                <label for="exampleInputEmail1" class="form-label">Tanggal</label>
                <input type="string" name="tanggal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="DD/MM/YYYY" value="{{ $data->tanggal }}">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1" class="form-label">Id Poin</label>
                <input type="string" name="id_poin" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->id_poin }}">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1" class="form-label">Jumlah Tukar</label>
                <input type="string" name="jumlah" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->jumlah }}">
              </div>
              </div>
            <p>
