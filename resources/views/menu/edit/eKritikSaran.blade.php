      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <form action="/updateKritikSaran/{{ $data->id }}" method="POST" enctype="multipart/form-data">
            @csrf
              ...
              <div class="form-group">
                ...
                <input type="string" name="kritiksaran" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->kritiksaran }}">
              </div>
              <p>
