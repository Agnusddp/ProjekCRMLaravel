        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"><i class="fa fa-user"></i> Input Data Pengguna</li>
            </ol>
            <form action="/updatePoinp/{{ $data->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
              ...
              <div class="form-group">
                <div class="mb-3">
                  ...
                  <div class="form-group">
                    ...
                    <option value="{{ $row->id }}">{{ $row->id_pelanggan }}-{{ $row->nama }}</option>
                    @endforeach
                    </select>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <input type="string" name="poin" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->poin }}">
              </div>
              </div>
            <p>
