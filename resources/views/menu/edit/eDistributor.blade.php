      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <form action="/updateDistributor/{{ $data->id }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="form-group">
                <label for="exampleInputEmail1" class="form-label">ID Distributor</label>
                <input type="string" name="id_distributor" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  value="{{ $data->id_distributor }}">
              </div>
              <div class="form-group">
