...
<html lang="en">
  <head>
    ...
    <title>Optik Boss | Data Pelanggan</title>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"><i class="fa fa-user"></i> Data Pelanggan</li>
            </ol>
            <div class="col-lg-12">
            <div class="panel panel-default">
              <div class="panel-body">
              <a href="iPelanggan"><button type="button" class="btn btn-success">Tambah Data</button></a> <br> <br>
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    @foreach ($data as $a)
                      <tr>
                        ...
                        <td>{{ $a->email }}</td>
                        <td>
                            <a href="/editPelanggan/{{ $a->id }}" class="btn btn-info" data-mdc-auto-init="MDCRipple"> Edit </a>
                            <a href="/delPelanggan/{{ $a->id }}" class="btn btn-danger" data-mdc-auto-init="MDCRipple"> Hapus </a>
                        </td>
                     </tr>
                    @endforeach
                    </tbody>
