  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Input Data Penukaran Poin</h1>
            <ol class="breadcrumb">
              <li><i class="fa fa-star"></i> Point</li>
              <li><i class="fa fa-clock-o"></i> Penukaran Poin</li>
              <li class="active"><i class="fa fa-clock-o"></i> Input Penukaran Poin</li>
            </ol>
            <form action="/instPenukaranp" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="exampleInputEmail1" class="form-label">Id Penukaran</label>
                <input type="string" name="id_penukaran" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
            <div class="form-group">
                <label for="exampleInputEmail1" class="form-label">Tanggal</label>
                <input type="string" name="tanggal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="DD/MM/YYYY">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="string" name="jumlah" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
              </div>
            <p>
