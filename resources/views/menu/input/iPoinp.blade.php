  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Input Data Poin Pelanggan</h1>
            <ol class="breadcrumb">
              <li><i class="fa fa-star"></i> Poin</a></li>
              <li><i class="fa fa-star"></i> Data Poin Pelanggan</li>
              <li class="active"><i class="fa fa-star"></i> Input Data Poin Pelanggan</li>
            </ol>
            <form action="/instPoinp" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="string" name="poin" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
              </div>
            <p>
