        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Input Data Pegawai</h1>
              ...
              <li class="active"><i class="fa fa-user"></i> Input Data Pegawai</li>
            </ol>
            <form action="/instPegawai" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="string" name="id_pegawai" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
              <div class="form-group">
