    ...
    <div id="wrapper">
     ...
     <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Input Data Kritik dan Saran</h1>
            <ol class="breadcrumb">
              <li><i class="fa fa-book"></i> Kritik dan Saran</li>
              <li><i class="fa fa-book"></i> Data Kritik dan Saran</li>
              <li class="active"><i class="fa fa-book"></i> Input Data Kritik dan Saran</li>
            </ol>
            <form action="/instKritikSaran" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="exampleInputEmail1" class="form-label">ID Kritik dan Saran</label>
                <input type="string" name="id_kritiksaran" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="exampleInputEmail1" class="form-label">Kritik dan Saran</label>
                <input type="string" name="kritiksaran" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
              <p>
