...
<html lang="en">
  <head>
    ...
    <title>Optik Boss | Data Pengguna</title>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="panel panel-default">
              ...
              <a href="iPengguna"><button type="button" class="btn btn-success">Tambah Data</button></a> <br> <br>
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    @foreach ($data as $a)
                      <tr>
                        ...
                        <td>{{ $a->kategori }}</td>
                        <td>
                            <a href="/editPengguna/{{ $a->id }}" class="btn btn-info" data-mdc-auto-init="MDCRipple"> Edit </a>
                            <a href="/delPengguna/{{ $a->id }}" class="btn btn-danger" data-mdc-auto-init="MDCRipple"> Hapus </a>
                        </td>
                     </tr>
                    @endforeach
                    </tbody>
