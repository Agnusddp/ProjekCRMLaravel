...
<html lang="en">
  <head>
    ...
    <title>Optik Boss | Data Transaksi Konsumen</title>
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Transaksi Konsumen</h1>
            <ol class="breadcrumb">
              <li><i class="fa fa-shopping-cart"></i> Transaksi</a></li>
              <li class="active"><i class="fa fa-shopping-cart"></i> Transaksi Konsumen</li>
            </ol>
            <div class="col-lg-12">
            <div class="panel panel-default">
              <div class="panel-body">
              <a href="iTkonsumen"><button type="button" class="btn btn-success">Tambah Data</button></a> <br> <br>
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tr>
                        ...
                        <td>{{ $a->tanggal }}</td>
                        <td>{{ $a->konsumen->id_konsumen }}</td>
                        <td>{{ $a->barang->id_barang }}</td>
                        <td>{{ $a->jenis }}</td>
                        <td>{{ $a->pegawai->id_pegawai }}</td>
                        <td>
                            <a href="/editTkonsumen/{{ $a->id }}" class="btn btn-info" data-mdc-auto-init="MDCRipple"> Edit </a>
                            <a href="/delTkonsumen/{{ $a->id }}" class="btn btn-danger" data-mdc-auto-init="MDCRipple"> Hapus </a>
                        </td>
                    </tr>
                    @endforeach
                  </table>
