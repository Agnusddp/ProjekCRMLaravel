        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"><i class="fa fa-clock-o"></i> Penukaran Poin</li>
            </ol>
            <div class="col-lg-12">
            <div class="panel panel-default">
              <div class="panel-body">
              <a href="iPenukaranp"><button type="button" class="btn btn-success">Tambah Data</button></a> <br> <br>
              <div class="table-responsive text-center">
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    @foreach ($data as $a)
                    <tr>
                        <td>{{ $a->id_penukaran }}</td>
                        <td>{{ $a->tanggal }}</td>
                        <td>{{ $a->id_poin }}</td>
                        <td>{{ $a->Jumlah }}</td>
                        <td>
                            <a href="/editPenukaranp/{{ $a->id }}" class="btn btn-info" data-mdc-auto-init="MDCRipple"> Edit </a>
                            <a href="/delPenukaranp/{{ $a->id }}" class="btn btn-danger" data-mdc-auto-init="MDCRipple"> Hapus </a>
                        </td>
                    </tr>
                    @endforeach
                  </table>
