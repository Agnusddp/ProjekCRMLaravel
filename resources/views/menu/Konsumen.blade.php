...
<html lang="en">
  <head>
    ...
    <title>Optik Boss | Data Konsumen</title>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Data Konsumen</h1>
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-user"></i> Costumer > <i class="fa fa-user"></i> Data Konsumen</li>
            </ol>
            <div class="col-lg-12">
            <div class="panel panel-default">
              <div class="panel-body">
              <a href="iKonsumen"><button type="button" class="btn btn-success">Tambah Data</button></a> <br> <br>
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    @foreach ($data as $a)
                      <tr>
                        ...
                        <td>{{ $a->email }}</td>
                        <td>
                            <a href="/editKonsumen/{{ $a->id }}" class="btn btn-info" data-mdc-auto-init="MDCRipple"> Edit </a>
                            <a href="/delKonsumen/{{ $a->id }}" class="btn btn-danger" data-mdc-auto-init="MDCRipple"> Hapus </a>
                        </td>
                     </tr>
                    @endforeach
                    </tbody>
