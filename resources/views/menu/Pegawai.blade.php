...
<html lang="en">
  <head>
    ...
    <title>Optik Boss | Data Pegawai</title>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          ...
          <ul class="nav navbar-nav navbar-right navbar-user">
            <li class="dropdown user-dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Log Out</a>
            </li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </nav>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"><i class="fa fa-user"></i> Data Pegawai</li>
            </ol>
          </div>
          <div class="col-lg-12">
            <div class="panel panel-default">
              <div class="panel-body">
              <a href="iPegawai"><button type="button" class="btn btn-success" >Tambah Data</button></a> 
              @If (count($data) > 0)
                <a href="exportPegawai/{{ $data[0]->id }}"><button type="button" class="btn btn-success" >Download PDF</button></a> <br> <br>
              @endif
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    @foreach ($data as $a)
                      <tr>
                        ...
                        <td>{{ $a->email }}</td>
                        <td>
                            <a href="/editPegawai/{{ $a->id }}" class="btn btn-info" data-mdc-auto-init="MDCRipple"> Edit </a>
                            <a href="/delPegawai/{{ $a->id }}" class="btn btn-danger" data-mdc-auto-init="MDCRipple"> Hapus </a>
                        </td>
                     </tr>
                    @endforeach
                    </tbody>
