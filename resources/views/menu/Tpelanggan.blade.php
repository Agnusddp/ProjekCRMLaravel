        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="panel panel-default">
              ...
              <a href="iTpelanggan"><button type="button" class="btn btn-success">Tambah Data</button></a> <br> <br>
              <div class="table-responsive text-center">
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/editTpelanggan/{{ $a->id }}" class="btn btn-info" data-mdc-auto-init="MDCRipple"> Edit </a>
                            <a href="/delTpelanggan/{{ $a->id }}" class="btn btn-danger" data-mdc-auto-init="MDCRipple"> Hapus </a>
                        </td>
                    </tr>
                    @endforeach
                  </table>
