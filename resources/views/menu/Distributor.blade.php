...
<html lang="en">
  <head>
    ...
    <title>Optik Boss | Data Distributor</title>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"><i class="fa fa-truck"></i> Data Distribuor</li>
            </ol>
            <div class="col-lg-12">
            <div class="panel panel-default">
              <div class="panel-body">
              <a href="iDistributor"><button type="button" class="btn btn-success">Tambah Data</button></a> <br> <br>
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    @foreach ($data as $a)
                      <tr>
                        ...
                        <td>{{ $a->email }}</td>
                        <td>
                            <a href="/editDistributor/{{ $a->id }}" class="btn btn-info" data-mdc-auto-init="MDCRipple"> Edit </a>
                            <a href="/delDistributor/{{ $a->id }}" class="btn btn-danger" data-mdc-auto-init="MDCRipple"> Hapus </a>
                        </td>
                     </tr>
                    @endforeach
                    </tbody>
