      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Kritik & Saran</h1>
            <ol class="breadcrumb">
              <li><i class="fa fa-star"></i> Kritik & Saran</li>
              <li class="active"><i class="fa fa-star"></i> Data Kritik & Saran</li>
            </ol>
            <div class="col-lg-12">
            <div class="panel panel-default">
              <div class="panel-body">
              <a href="iKritikSaran"><button type="button" class="btn btn-success">Tambah Data</button></a> <br> <br>
              <div class="table-responsive text-center">
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    @foreach ($data as $a)
                      <tr>
                        <td>{{ $a->id_kritiksaran }}</td>
                        <td>{{ $a->pengguna->id_pengguna }}</td>
                        <td>{{ $a->kritiksaran }}</td>
                        <td>
                            <a href="/editKritikSaran/{{ $a->id }}" class="btn btn-info" data-mdc-auto-init="MDCRipple"> Edit </a>
                            <a href="/delKritikSaran/{{ $a->id }}" class="btn btn-danger" data-mdc-auto-init="MDCRipple"> Hapus </a>
                        </td>
                      </tr>
                    @endforeach
                    </tbody>
